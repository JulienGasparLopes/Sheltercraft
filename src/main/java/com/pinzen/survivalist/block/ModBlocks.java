package com.pinzen.survivalist.block;

import com.pinzen.survivalist.Survivalist;
import com.pinzen.survivalist.block.custom.CuttingStump;
import com.pinzen.survivalist.block.entity.custom.CuttingStumpBE;
import com.pinzen.survivalist.block.custom.WickerBasket;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Item> CUTTING_STUMP_ITEM = Survivalist.REGISTER_ITEMS.register("cutting_stump",
            () -> new BlockItem(ModBlocks.CUTTING_STUMP.get(), new Item.Properties().setId(Survivalist.REGISTER_ITEMS.key("cutting_stump"))));
    ...
    public static final RegistryObject<Item> WICKER_BASKET_ITEM = Survivalist.REGISTER_ITEMS.register("wicker_basket",
            () -> new BlockItem(ModBlocks.WICKER_BASKET.get(), new Item.Properties().setId(Survivalist.REGISTER_ITEMS.key("wicker_basket"))));
